...
console.log("prova");
const prova = async () => {
    const vbs = path.resolve("prova.vbs");
    console.log(vbs);
    const file = path.resolve("adodb.mdb");
    console.log(file);
    const result = await (0, run_vbs_1.runVbsFile)({
        vbs,
        args: ["adodb.mdb", "JSON"],
    });
    console.log(result);
...
Wscript.Echo schema`;
const provaFromString = async () => {
    const vbs = stringVBS;
    console.log(vbs);
    const file = path.resolve("adodb.mdb");
    console.log(file);
    const result = await (0, run_vbs_1.runVbs)({
        vbs,
        args: ["adodb.mdb", "JSON"],
    });
    console.log(result);
